...
const topics: Topic[] = [
  ...
  ['philippines-outsourcing-work-sample-validity', 'Work-sample design for Philippines outsourcing hiring', 'Use a consistent, job-related work sample to compare candidates without confusing polish with operational fit.', '3', 'Parts of a fair sample', 'Give the same source, instructions, time box, and rubric; assess accuracy, evidence, and escalation judgment.', 'The three-part sample is a practical design: normal case, incomplete case, and stop/escalate case. Have counsel review selection practices where required.'],
