  ...
  return <>
    ...
    <main className="section">
      ...
      <article className="container guide-article" data-article-marker={details?.marker}>
        ...
        {['2026-09-04', '2026-09-07', '2026-09-08', '2026-09-09', '2026-09-10', '2026-09-14', '2026-09-18', '2026-09-22', '2026-09-23', '2026-09-24'].includes(details?.updated) ? <img src="/images/operations-meeting.jpg" alt="Operations teammates reviewing documented evidence together" style={{ width: '100%', height: 'auto', borderRadius: 12, margin: '1.5rem 0' }} /> : null}
