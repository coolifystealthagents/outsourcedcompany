    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Company comparison journal</p>
          <h1>Outsourced Company: a buyer journal for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced company guide for small businesses deciding what company functions to outsource first. The page now uses a distinct newspaper-inspired layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>newspaper columns and comparison rules</figcaption></figure>
      </div>
    </section>
