...
MARKER = 'philippines-va-first-task-map-2026'
OLD_SLUG = 'call-center-outsourcing-philippines'
OLD_MARKER = 'call-center-philippines-queue-map-2026'
...
checks = {
    ...
    'h1': ' '.join(p.h1) == 'Virtual assistant in the Philippines: what to hand off first',
    ...
    'exact_quote': p.quotes == 1 and 'Working 55 hours or more per week is a serious health hazard' in article_text,
    'dated_stats': all(x in article_text for x in ['59.55%', '745,000', '35%', '17%']),
    ...
    'old_route_regression': old.article_marker == OLD_MARKER and 'Start with the queue, not the headcount' in ' '.join(old.text),
}
result = {
