...
const batch=fs.readFileSync('app/article-research-batch-2026-09-22.ts','utf8');
...
for(const article of manifest.articles){
  if(article.publicationDate!=='2026-09-22') throw new Error(`Wrong date for ${article.slug}`);
  ...
  if(!html.includes('2026-09-22')) throw new Error(`Structured publication date missing: ${article.slug}`);
...
console.log('Validated exactly 5 September 22 Research pages.');
