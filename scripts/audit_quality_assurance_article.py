...
OLD_SLUG = 'virtual-assistant-philippines-first-tasks'
OLD_MARKER = 'philippines-va-first-task-map-2026'
...
checks = {
    ...
    'h1': ' '.join(p.h1) == 'Philippines outsourcing quality assurance checklist',
    ...
    'old_route_regression': old.article_marker == OLD_MARKER and 'Pick work that has a clear finish' in ' '.join(old.text),
}
result = {
