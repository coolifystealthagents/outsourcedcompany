...
const source=fs.readFileSync('app/article-blog-2026-09-22.ts','utf8');
...
for(const entry of manifest.entries){
  ...
  assert.ok(html.includes('2026-09-22'),`${entry.slug}: date missing`);
...
console.log('PASS: 12 September 22 Blog routes, 900+ words, dates, canonicals, image, and sitemap entries');
